...
<head>
	...
	<style>
		...
		* {
		...
		.overlay {
			background: #CCFF00;
			background: -webkit-linear-gradient(to right, #CCFF00, #CCFF00);
			background: linear-gradient(to right, #CCFF00, #CCFF00);
	...
	<div class="container" id="container">
		<div class="form-container sign-up-container">
			<form action="#" method="POST">
				...
				<span><b>Password Requirements</b><br> Minimum 8 characters<br> At least one uppercase letter and lower case<br>One number and one special character<br></span>
